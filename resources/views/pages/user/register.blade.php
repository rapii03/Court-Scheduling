...
<body class="flex justify-center items-center h-screen bg-gray-100">
    <div class="w-full max-w-xl">
        <form class="bg-white shadow-md rounded px-8 p-5 m-5">
            ...
            <div class="flex justify-between gap-5">
                ...
                <div class="mb-4 w-[50%]">
                    ...
                    <input name=""
                        class="shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="email" type="number" placeholder="NIM" minlength="8" maxlength="20" required>
                </div>
            </div>
            <div class="flex justify-between gap-5">
                <div class="mb-4 w-[50%]">
                    ...
                    <input name=""
                        class="shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="email" type="text" placeholder="Nama" maxlength="100" required>
                </div>
                <div class="mb-4 w-[50%]">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="password">
                        Password
                    ...
                    <div class="relative">
                        <input name=""
                            class="shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            id="password" type="password" placeholder="Password" minlength="8" maxlength="12"
                            required>
                        <i
                            class="fas fa-eye-slash absolute top-0 right-0 mt-1 mr-3 text-gray-500 eye-icon cursor-pointer">
            ...
            <div class="flex justify-between gap-5">
                <div class="mb-4 w-[50%]">
                    ...
                    <input name=""
                        class="shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="dosenPembimbing1" type="text" placeholder="Dosen Pembimbing 1" maxlength="100" required>
                </div>
                <div class="mb-4 w-[50%]">
                    ...
                    <input name=""
                        class="shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="dosenPembimbing2" type="email" placeholder="Dosen Pembimbing 2" maxlength="100" required>
                </div>
            </div>
            <div class="flex justify-between gap-5">
                <div class="mb-4 w-[50%]">
                    ...
                    <input name=""
                        class="shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="bidangKeahlian" type="text" placeholder="Bidang Keahlian" maxlength="100" required>
                </div>
                <div class="mb-4 w-[50%]">
                    ...
                    <input name=""
                        class="shadow appearance-none border rounded w-full text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="judulTugasAkhir" type="text" placeholder="Judul Tugas AKhir" maxlength="100"
                        required>
                </div>
            </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 mt-10 text-black font-bold text-[18px]">Your account has been successfully created!
                    </h3>
