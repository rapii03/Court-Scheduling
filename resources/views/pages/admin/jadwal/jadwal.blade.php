    ...
    <div class="ml-[228px] p-5">
        ...
        <form action="" class="flex justify-between">
            <div class="relative flex items-center justify-center">
                <input type="search" id="default-search" name="search" class="block h-[32px] w-full rounded-lg border border-[#00000] bg-gray-50 p-4 ps-10 text-sm text-gray-900 focus:border-[#C8AC5E] focus:ring-[#C8AC5E]" placeholder="Cari Berdasarkan Nama" />
            ...
            <div class="relative flex gap-2">
                ...
                <div class="mb-4 w-[40%]">
                    <input name="date" class="focus:shadow-outline w-full appearance-none rounded border leading-tight text-gray-700 shadow focus:outline-none" id="filterTanggal" type="date" value="{{ request()->query('date') }}" onchange="this.form.submit()" required>
                    @error('date')
                        <p>{{ $message }}</p>
                    @enderror
                </div>
