...
<head>
    ...
    <title>Seminar Proposal | Data Dokumen</title>
...
<body>
    ...
    <div class="ml-[228px] p-5">
        <div class="mb-2 text-[40px] font-bold">Data Dokumen Seminar Proposal</div>
        ...
        'ppt_file' => 'File PPT',
            ...
            <div class="mt-[25px] flex justify-between">
                <div class="div">
                    <a href="/DataPendaftaran/SeminarProposal" type="button" class="mb-2 me-2 inline-flex items-center gap-2 rounded-lg bg-[#C8AC5E] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#C8AC5E]/90 focus:outline-none focus:ring-4 focus:ring-[#3b5998]/50">
                        <div class="text-[14px]">
                            Back
                        </div>
                    </a>
