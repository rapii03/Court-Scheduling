        ...
        <div class="relative mt-2 overflow-x-auto">
            <table class="w-full text-left text-sm text-black rtl:text-right">
                <thead class="bg-[#1F5F92] text-white">
                    <tr>
                        <th scope="col" class="m-auto items-center justify-center rounded-tl-lg px-2 py-1 text-center">
                            No
                        </th>
                ...
                <tbody class="border-1 border border-black">
                    @foreach ($seminars as $seminar)
                        <tr class="border-1 border border-black bg-white">
                            ...
                            @foreach ([$seminar->supervisor_1, $seminar->supervisor_2, $seminar->examiner_1, $seminar->examiner_2] as $supervisor)
                                @php
                            ...
                            <td class="flex px-6 py-4">
                                <div>
                                    <a href="/DataPendaftaran/SidangAkhir/DataDokumen?id={{ $seminar->id }}">
