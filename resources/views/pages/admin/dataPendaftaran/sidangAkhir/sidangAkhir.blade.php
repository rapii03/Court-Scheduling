...
<body>
    ...
    <div class="ml-[228px] p-5">
        ...
        <div class="flex justify-start">
            <div class="text-[25px] font-bold">Tabel Data Pendaftaran Sidang Akhir</div>
        </div>
        <div class="relative overflow-x-auto mt-2">
            <table class="w-full text-sm text-left rtl:text-right text-black">
                <thead class="text-white bg-[#1F5F92]">
                    <tr>
                        <th scope="col"
                            class="px-2 py-1 rounded-tl-lg text-center items-center justify-center m-auto">
                            No
                        </th>
                ...
                <tbody class="border border-1 border-black">
                    ...
                    <tr class="bg-white border border-1 border-black">
                        ...
                        <td class="px-6 py-4 flex">
                            <div>
                                <a href="/DataPendaftaran/SidangAkhir/DataDokumen">
