...
<body>
    ...
    <div class="ml-[228px] p-5">
        <div class="mb-10 text-[40px] font-bold">Edit Data Dosen</div>
                    ...
                    <div class="relative ml-20 w-[30%]">
                        <div class="align-center relative m-auto mt-24 flex items-center justify-center">
                            ...
                            <label for="file-input" class="relative cursor-pointer">
                                ...
                                <img id="selected-image" src="{{ $user->lectureData->image !== null ? url(asset('storage/' . $user->lectureData->image)) : '' }}" alt="Selected Image" class="hidden" />
                                <input id="file-input" type="file" name="image" class="hidden" accept="image/*" value="" />
