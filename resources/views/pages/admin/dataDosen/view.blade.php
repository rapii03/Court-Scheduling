...
<body>
    ...
    <div class="ml-[228px] p-5">
        <div class="text-[40px] font-bold mb-10">Profil Andre Febrianto</div>
        <div class="w-full h-[600px] rounded-lg bg-[#1F5F92]">
            <div class="p-10">
                <div class="w-full">
                    <div class="justify-center items-center flex m-auto align-center">
                        <svg width="169" height="184" viewBox="0 0 169 184" fill="none"
                    ...
                    <div class="relative overflow-x-auto overflow-y-auto bg-white p-5 rounded-lg mt-10">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 bg-transparent font-bold">
                            <tbody>
                                <tr class="text-black">
                                    <td class="px-3 py-2">
                                        Email
                                ...
                                <tr class="text-black">
                                    ...
                                    <td class="px-5 py-2 flex gap-2">
                                        : andre.febrianto@if.itera.ac.id
                                    </td>
                                </tr>
                                <tr class="text-black">
                                    <td class="px-3 py-2">
