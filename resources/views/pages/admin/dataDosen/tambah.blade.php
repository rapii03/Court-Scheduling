...
<body>
    ...
    <div class="ml-[228px] p-5">
        <div class="mb-10 text-[40px] font-bold">Tambah Data Dosen</div>
        <form action="" method="POST" class="h-[600px] w-full rounded-lg bg-[#1F5F92]" enctype="multipart/form-data">
            @csrf
            <div class="p-20">
                <div class="flex gap-10">
                    <div class="relative ml-20 w-[30%]">
                        <div class="align-center relative m-auto mt-24 flex items-center justify-center">
                            <div id="hapus-icon-container" class="absolute bottom-2 left-2 z-50 hidden cursor-pointer">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M2.5 3.75V5H3.75V17.5C3.75 17.8315 3.8817 18.1495 4.11612 18.3839C4.35054 18.6183 4.66848 18.75 5 18.75H15C15.3315 18.75 15.6495 18.6183 15.8839 18.3839C16.1183 18.1495 16.25 17.8315 16.25 17.5V5H17.5V3.75H2.5ZM5 17.5V5H15V17.5H5Z" fill="#872929" />
                                    <path d="M7.5 1.25H12.5V2.5H7.5V1.25Z" fill="#872929" />
                                </svg>
                            </div>
                            <label for="file-input" class="relative cursor-pointer">
                                <div id="svg-container">
                                    <svg id="svg-icon" width="169" height="184" viewBox="0 0 169 184" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td class="flex gap-2 px-5 py-2">
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-full">
                                                    <div class="relative">
                                                        <input type="text" id="phone-input" name="email" aria-describedby="helper-text-explanation" class="block h-[21px] w-[250px] border border-black bg-gray-50 p-2.5 ps-2 text-sm text-black focus:border-black focus:ring-black" placeholder="Masukkan Email" value="{{ old('email') }}" required />
                                                        @error('email')
                                                            <p>{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td class="flex gap-2 px-5 py-2">
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-full">
                                                    <div class="relative">
                                                        <input type="text" id="phone-input" name="name" aria-describedby="helper-text-explanation" class="block h-[21px] w-[250px] border border-black bg-gray-50 p-2.5 ps-2 text-sm text-black focus:border-black focus:ring-black" placeholder="Masukkan Nama" value="{{ old('name') }}" required />
                                                        @error('name')
                                                            <p>{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td class="flex gap-2 px-5 py-2">
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-full">
                                                    <div class="relative">
                                                        <input type="text" id="phone-input" name="nip" aria-describedby="helper-text-explanation" class="block h-[21px] w-[250px] border border-black bg-gray-50 p-2.5 ps-2 text-sm text-black focus:border-black focus:ring-black" placeholder="Masukkan NIP" value="{{ old('nip') }}" required />
                                                        @error('nip')
                                                            <p>{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td class="flex gap-2 px-5 py-2">
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-full">
                                                    <div class="relative">
                                                        <input type="text" id="phone-input" name="nidn" aria-describedby="helper-text-explanation" class="block h-[21px] w-[250px] border border-black bg-gray-50 p-2.5 ps-2 text-sm text-black focus:border-black focus:ring-black" placeholder="Masukkan NIDN" value="{{ old('nidn') }}" required />
                                                        @error('nidn')
                                                            <p>{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td class="flex gap-2 px-5 py-2">
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-full">
                                                    <div class="relative">
                                                        <input type="text" id="phone-input" name="kk" aria-describedby="helper-text-explanation" class="block h-[21px] w-[250px] border border-black bg-gray-50 p-2.5 ps-2 text-sm text-black focus:border-black focus:ring-black" placeholder="Masukkan Kelompok Keahlian" value="{{ old('kk') }}" required />
                                                        @error('kk')
                                                            <p>{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td class="flex gap-2 px-5 py-2">
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-full">
                                                    <div class="relative">
                                                        <input type="text" id="phone-input" name="phone_number" aria-describedby="helper-text-explanation" class="block h-[21px] w-[250px] border border-black bg-gray-50 p-2.5 ps-2 text-sm text-black focus:border-black focus:ring-black" placeholder="Masukkan Nomor Telepon" value="{{ old('phone_number') }}" required />
                                                        @error('phone_number')
                                                            <p>{{ $message }}</p>
                                                        @enderror
                                                    </div>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td class="flex gap-2 px-5 py-2">
                                            ...
                                            <div class="flex items-center">
                                                <div class="w-full">
                                                    <div class="relative">
                                                        <input type="text" id="phone-input" name="address" aria-describedby="helper-text-explanation" class="block h-[21px] w-[250px] border border-black bg-gray-50 p-2.5 ps-2 text-sm text-black focus:border-black focus:ring-black" placeholder="Masukkan Alamat" value="{{ old('address') }}" required />
                                                        @error('address')
                                                            <p>{{ $message }}</p>
                                                        @enderror
                                                    </div>
            ...
            <div class="ml-10 mr-10 mt-[25px] flex justify-between">
                ...
                <div class="div">
                    ...
                    <button type="submit" class="mb-2 me-2 inline-flex items-center gap-2 rounded-lg bg-[#C8AC5E] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#C8AC5E]/90 focus:outline-none focus:ring-4 focus:ring-[#3b5998]/50">
                        <div class="text-[14px]">
                            Submit
                        </div>
                    </button>
