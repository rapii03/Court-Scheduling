    ...
    <aside id="default-sidebar"
        class="fixed top-0 left-0 z-70 w-[228px] h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar">
        <div class="h-full py-6 bg-[#1F5F92]">
            <div class="mb-5">
                <a href="#">
                    <div class="text-center m-auto justify-center flex text-black text-[30px] font-bold">SchedulerTI
                    </div>
                </a>
            </div>
  ...
  @if (in_array(Request::path(), $dashboard)) rounded-lg bg-[#C8AC5E] text-white focus:z-10 focus:ring-1 focus:ring-white focus:text-white
        @else
            text-black rounded-lg hover:bg-[#C8AC5E] hover:text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white @endif">
                        ...
                        <li class="flex items-center justify-center inset-x-0 bg-[#EBEBEB] rounded-lg">
                            ...
                            @endphp
                            <a href="/DataDosen" type="button"
                                class="group w-full h-[45px] p-1 pl-5 flex gap-6 text-lg font-medium
        @if (in_array(Request::path(), $activePagePath2)) rounded-lg bg-[#C8AC5E] text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white
        @else
            text-black rounded-lg hover:bg-[#C8AC5E] hover:text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white @endif">
                                <div class="text-start justify-center items-center flex">
                                    <svg width="23" height="27" viewBox="0 0 23 27" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M3.0979 10.35V1.94995H18.325L22 5.62495V25.05H14.65M16.75 1.94995V7.19995H22M6.25 18.75C5.83634 18.75 5.42672 18.6685 5.04455 18.5102C4.66237 18.3519 4.31512 18.1198 4.02261 17.8273C3.73011 17.5348 3.49808 17.1876 3.33978 16.8054C3.18148 16.4232 3.1 16.0136 3.1 15.6C3.1 15.1863 3.18148 14.7767 3.33978 14.3945C3.49808 14.0123 3.73011 13.6651 4.02261 13.3726C4.31512 13.0801 4.66237 12.848 5.04455 12.6897C5.42672 12.5314 5.83634 12.45 6.25 12.45C7.08543 12.45 7.88665 12.7818 8.47739 13.3726C9.06813 13.9633 9.4 14.7645 9.4 15.6C9.4 16.4354 9.06813 17.2366 8.47739 17.8273C7.88665 18.4181 7.08543 18.75 6.25 18.75ZM6.25 18.75C4.15 18.75 1 19.8 1 24V25.05H11.5V24C11.5 19.8 8.35 18.75 6.25 18.75Z"
                                            stroke="currentColor" stroke-width="2" />
                                    </svg>
                                </div>
                                <div class="text-start justify-center items-center flex text-[14px] font-bold">Data
                                    Dosen</div>
                            </a>
                        </li>
                        <li class="flex items-center justify-center inset-x-0 mt-2 bg-[#EBEBEB] rounded-lg">
                            @php
                                $activePagePath3 = [
                                    'DataPendaftaran',
                                    'DataPendaftaran/SeminarProposal',
                                    'DataPendaftaran/SeminarProposal/DataDokumen',
                                    'DataPendaftaran/SidangAkhir',
                                    'DataPendaftaran/SidangAkhir/DataDokumen',
                                ];
                                if (isset($id)) {
                                    array_push($activePagePath3, 'admin-tendik-slb/edit/' . $id);
                                }
                            @endphp
                            <a href="/DataPendaftaran" type="button"
                                class="group w-full h-[45px] p-1 pl-5 flex gap-6 text-lg font-medium
        @if (in_array(Request::path(), $activePagePath3)) rounded-lg bg-[#C8AC5E] text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white
        @else
            text-black rounded-lg hover:bg-[#C8AC5E] hover:text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white @endif">
                                <div class="text-start justify-center items-center flex">
        ...
        @else
            text-black rounded-lg hover:bg-[#C8AC5E] hover:text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white @endif">
                        ...
                        <li class="flex items-center justify-center inset-x-0 mt-2 bg-[#EBEBEB] rounded-lg">
                            ...
                            @endphp
                            <a href="/Jadwal" type="button"
                                class="group w-full h-[45px] p-1 pl-5 flex gap-6 text-lg font-medium
        @if (in_array(Request::path(), $activePagePath5)) rounded-lg bg-[#C8AC5E] text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white
        @else
            text-black rounded-lg hover:bg-[#C8AC5E] hover:text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white @endif">
                                <div class="text-start justify-center items-center flex">
                                    <svg width="21" height="17" viewBox="0 0 21 17" fill="none"
                        ...
                        <li class="flex items-center justify-center inset-x-0 mt-2 bg-[#EBEBEB] rounded-lg">
                            ...
                            <a href="/DataUser" type="button"
                                class="group w-full h-[45px] p-1 pl-5 flex gap-6 text-lg font-medium
        @if (in_array(Request::path(), $activePagePath6)) rounded-lg bg-[#C8AC5E] text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white
        @else
            text-black rounded-lg hover:bg-[#C8AC5E] hover:text-white focus:z-10 focus:ring-2 focus:ring-white focus:text-white @endif">
                                <div class="text-start justify-center items-center flex">
